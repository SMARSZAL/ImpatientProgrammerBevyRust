...
pub fn build_props_layer(
    ...
    terrain_model_builder.create_model(
        stump_prop.clone(),
        vec![SpawnableAsset::new("tree_stump_2").with_pickable(ItemKind::TreeStump2)],
    );
    terrain_model_builder.create_model(
        stump_prop.clone(),
    ...
    terrain_model_builder.create_model(
        plant_prop.clone(),
        vec![SpawnableAsset::new("plant_1").with_pickable(ItemKind::Plant1)],
    );
    terrain_model_builder.create_model(
        plant_prop.clone(),
        vec![SpawnableAsset::new("plant_2").with_pickable(ItemKind::Plant2)],
    );
    terrain_model_builder.create_model(
        plant_prop.clone(),
        vec![SpawnableAsset::new("plant_3").with_pickable(ItemKind::Plant3)],
    );
    terrain_model_builder.create_model(
        plant_prop.clone(),
        vec![SpawnableAsset::new("plant_4").with_pickable(ItemKind::Plant4)],
    );
